...
| **STRIDE threat modeling** | `results/threat-model/` | [`assessment-agent`](../ai-tooling/agents/assessment-agent/AGENT.md) | [`threat-model`](../ai-tooling/skills/reporting/threat-model/SKILL.md) | `python scripts/results/build_threat_model.py` |
| **Shadow API scanning (OWASP Noir)** | `results/reports/` | [`artifact-agent`](../ai-tooling/agents/artifact-agent/AGENT.md) | [`noir-scan`](../ai-tooling/skills/reporting/noir-scan/SKILL.md) | `python scripts/results/run_noir_scan.py` |
...
| **Slack messaging & Block Kit alerts** | Slack / `koality-assured` | [`chat-collab-agent`](../ai-tooling/agents/chat-collab-agent/AGENT.md) | [`slack-message`](../ai-tooling/skills/slack/slack-message/SKILL.md) | `python scripts/slack/slack_ops.py post-message --dry-run` |
| **Confluence page management & CQL** | Confluence / `koality-assured` | [`docs-collab-agent`](../ai-tooling/agents/docs-collab-agent/AGENT.md) | [`confluence-doc-manage`](../ai-tooling/skills/confluence/confluence-doc-manage/SKILL.md) | `python scripts/confluence/confluence_ops.py create-page --dry-run` |
| **Confluence space permissions & audit** | Confluence / `koality-assured` | [`docs-collab-agent`](../ai-tooling/agents/docs-collab-agent/AGENT.md) | [`confluence-admin`](../ai-tooling/skills/confluence/confluence-admin/SKILL.md) | `python scripts/confluence/confluence_admin.py audit-space --dry-run` |
| **Confluence Forge app & manifest authoring** | Confluence / `koality-assured` | [`docs-collab-agent`](../ai-tooling/agents/docs-collab-agent/AGENT.md) | [`confluence-app-manage`](../ai-tooling/skills/confluence/confluence-app-manage/SKILL.md) | `python scripts/confluence/confluence_app_manifest.py validate --dry-run` |
